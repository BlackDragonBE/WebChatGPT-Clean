...
const NavBar = (
    ...
    return (<div className="wcg-navbar wcg-sticky wcg-top-0 wcg-z-30 wcg-rounded-lg wcg-bg-base-200">
        <div className="wcg-flex-1 wcg-items-center wcg-gap-2">
            <img className="wcg-w-8 wcg-p-2" src="../icons/icon48.png" alt="WebChatGPT-Clean" />
            <span className="wcg-text-xl wcg-font-bold">WebChatGPT-Clean</span>
        ...
        <div className="wcg-flex-none wcg-gap-3">
            ...
            <IconButton url="https://github.com/BlackDragonBE/WebChatGPT-Clean" tip={getTranslation(localizationKeys.socialButtonTips.github)} icon={icons.github} />
        </div>
    </div>)
}
